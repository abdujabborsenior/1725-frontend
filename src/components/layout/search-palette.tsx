            ...
            <div>
              ...
              {QUICK_LINKS.map(({ href, label, icon: Icon }) => (
                <button
                  key={href}
                  onClick={() => go(href)}
                  className="flex w-full items-center gap-3 rounded-ios px-3 py-2.5 text-left transition-colors duration-150 active:bg-fill-tertiary"
                >
                ...
                <div className="mb-1">
                  ...
                  {userResults.map((u) => (
                    <button
                      ...
                      className="flex w-full items-center gap-3 rounded-ios px-3 py-2 text-left transition-colors duration-150 active:bg-fill-tertiary"
                    >
