...
export function UserX(props: IconProps) {
  return (
    <IconBase nativeStroke={32} {...props}>
      <path d="M376 144c-3.92 52.87-44 96-88 96s-84.15-43.12-88-96c-4-55 35-96 88-96s92 42 88 96" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" /><path d="M288 304c-87 0-175.3 48-191.64 138.6-2 10.92 4.21 21.4 15.65 21.4H464c11.44 0 17.62-10.48 15.65-21.4C463.3 352 375 304 288 304Z" fill="none" stroke="currentColor" strokeMiterlimit="10" /><path d="M144 232H32" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
    </IconBase>
  );
}
